...
export default function Form() {
  return (
    <form className="mt-6 max-w-xl sm:my-12 shadow-lg shadow-cyan-700 p-10">
          ...
          <div className="mt-10">
            <button
              type="button"
              className="block w-full rounded-md bg-cyan-500 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-cyan-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
            >
              Solicitar prueba
            </button>
          </div>
